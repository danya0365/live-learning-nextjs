...
## 💡 คำแนะนำเพิ่มเติมสำหรับผู้ใช้ (ลบส่วนนี้ทิ้งเวลาส่งให้ AI)
1. ให้ Copy ไฟล์นี้ไปไว้ในโฟลเดอร์ `prompt/` ของโปรเจคใหม่
2. แทนที่ `[ข้อความในวงเล็บ]` ด้วยข้อมูลจริงของโปรเจคนั้นๆ
3. ส่งไฟล์นี้ให้ AI อ่านเป็นอันดับแรกสุดตอนเริ่มสร้างโปรเจคใหม่
