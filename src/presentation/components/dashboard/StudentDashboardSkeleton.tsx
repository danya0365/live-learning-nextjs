        ...
        {[...Array(4)].map((_, i) => (
          <div key={i} className="glass rounded-2xl p-4 flex items-center justify-between animate-pulse">
            <div className="space-y-2">
              ...
              <div className="h-8 w-16 bg-slate-200/50 rounded-lg" />
            </div>
            <div className="h-12 w-12 bg-slate-200/50 rounded-full" />
          </div>
        ))}
      </div>
            ...
            <div className="space-y-4">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="glass border border-slate-200/50 rounded-xl p-4 flex gap-4 animate-pulse">
                  <div className="w-16 h-16 bg-slate-200/50 rounded-lg flex-shrink-0" />
            ...
            <div className="space-y-4">
              {[...Array(2)].map((_, i) => (
                <div key={i} className="glass border border-slate-200/50 rounded-xl p-4 animate-pulse">
                  <div className="h-32 w-full bg-slate-200/50 rounded-lg mb-3" />
                  <div className="h-5 w-3/4 bg-slate-200/50 rounded-lg mb-2" />
                  <div className="h-4 w-1/2 bg-slate-200/50 rounded-lg" />
                </div>
              ))}
            </div>
