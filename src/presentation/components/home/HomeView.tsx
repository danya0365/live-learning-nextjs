/**
 * HomeView
 * Beautiful home page with hero, featured courses, instructors, categories, and stats
 * Pure CSS animations — no react-spring
 */
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-text-secondary text-lg">กำลังโหลด Live Learning...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={actions.loadData} className="btn-game px-6 py-2 text-white rounded-xl">
            ลองใหม่อีกครั้ง
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {courses.map((course, index) => (
            <div key={course.id} className="glass rounded-2xl overflow-hidden group hover:scale-[1.02] transition-transform">
              {/* Thumbnail */}
