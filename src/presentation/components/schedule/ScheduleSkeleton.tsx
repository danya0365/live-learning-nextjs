      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="glass rounded-2xl p-4 text-center h-[90px] flex flex-col items-center justify-center animate-pulse">
            <div className="h-8 w-12 bg-slate-200/50 dark:bg-slate-700/50 rounded-lg mb-2" />
        ...
        {[...Array(2)].map((_, dayIndex) => (
          <div key={dayIndex}>
            <div className="flex items-center gap-4 mb-4">
              <div className="h-8 w-8 rounded-lg bg-slate-200/50 dark:bg-slate-700/50 animate-pulse" />
              <div className="h-8 w-32 bg-slate-200/50 dark:bg-slate-700/50 rounded-lg animate-pulse" />
            </div>
              ...
              {[...Array(3)].map((_, cardIndex) => (
                <div key={cardIndex} className="glass rounded-2xl p-5 h-[160px] animate-pulse">
                  <div className="flex justify-between items-start mb-4">
                    <div className="h-6 w-6 rounded-full bg-slate-200/50 dark:bg-slate-700/50" />
                    <div className="h-6 w-16 rounded-full bg-slate-200/50 dark:bg-slate-700/50" />
                  </div>
                  <div className="h-5 w-48 bg-slate-200/50 dark:bg-slate-700/50 rounded-lg mb-3" />
                  <div className="h-5 w-32 bg-slate-200/50 dark:bg-slate-700/50 rounded-lg mb-4" />
