...
type GlowColor = 'cyan' | 'purple' | 'pink' | 'green' | 'red' | 'orange' | 'emerald' | 'primary';
...
const glowColors: Record<GlowColor, { base: string; glow: string; hover: string }> = {
  ...
  emerald: {
    ...
    glow: 'shadow-emerald-600/30 hover:shadow-emerald-500/40',
    hover: 'hover:from-emerald-400 hover:to-emerald-600',
  },
  primary: {
    // Attempt to use theme tokens or fallback
    base: 'from-blue-500 to-indigo-600',
    glow: 'shadow-blue-500/30 hover:shadow-blue-400/40',
