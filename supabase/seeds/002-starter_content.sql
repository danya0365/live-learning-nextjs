...
SET 
  learning_outcomes = ARRAY['เข้าใจบทบาทและศักยภาพของ LINE OA เข้าใจฟังก์ชันหลัก เช่น Broadcast, Rich Menu, Auto-reply, Chat', 'พัฒนาทักษะการตั้งค่าและจัดการระบบ สร้างและตั้งค่าบัญชีให้เหมาะสมกับองค์กร', 'พัฒนาเนื้อหา (Content) ที่มีประสิทธิภาพ วางแผนปฏิทินเนื้อหา', 'เสริมทักษะการสื่อสารและการตอบแชท การใช้ภาษาที่เหมาะสม', 'เชื่อมโยงบริการออนไลน์สู่การใช้บริการจริง (Online to Offline)', 'วิเคราะห์และประเมินผลการดำเนินงาน อ่านค่าสถิติผู้ติดตาม'],
  requirements = ARRAY['มีความรู้เบื้องต้นในการใช้งานสมาร์ทโฟนและแอปพลิเคชัน LINE', 'มีบัญชี LINE ส่วนตัว'],
  target_audience = ARRAY['ผู้ที่ทำงานภาคสังคมและสาธารณสุขทั่วไป', 'องค์กรระดับท้องถิ่นหรือระดับประเทศที่ต้องการสื่อสารกับกลุ่มเป้าหมาย', 'ผู้ดูแลระบบหรือแอดมินขององค์กรที่ต้องให้การปรึกษา โฆษณา หรือนัดหมายผ่านช่องทางออนไลน์'],
  syllabus = '[{"title": "บทบาทและศักยภาพของ LINE OA และฟังก์ชันหลัก"}, {"title": "การตั้งค่าและจัดการระบบบัญชี LINE OA"}, {"title": "การสร้างและออกแบบคอนเทนต์ (Content) และ Rich Menu"}, {"title": "ทักษะการสื่อสาร การตอบแชท และการคัดกรองส่งต่อ"}, {"title": "การเชื่อมโยงบริการ Online to Offline (O2O)"}, {"title": "การวิเคราะห์สถิติและประเมินผลการดำเนินงาน"}]'::jsonb,
  about_course = 'องค์กรในยุคปัจจุบันจำเป็นต้องอาศัยแพลตฟอร์มการสื่อสารที่มีประสิทธิภาพ เพื่อบรรลุเป้าหมายในการให้บริการ คอร์สนี้ออกแบบมาเพื่อให้ทีมทำงานหรือบุคคลทั่วไปสามารถใช้ LINE OA เป็นเครื่องมือหลักในการสื่อสาร ให้ความรู้ ให้บริการ และเชื่อมโยงกลุ่มเป้าหมายเข้าสู่ระบบบริการจริงได้อย่างมีประสิทธิภาพ รวมถึงการติดตามผลเพื่อพัฒนาคุณภาพชีวิต หรือเพิ่มยอดขายและบริการ อย่างมืออาชีพ',
