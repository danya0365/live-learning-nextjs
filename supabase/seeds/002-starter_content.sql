...
VALUES
  ...
  -- 21. LangChain RAG
  (
    '40000000-0000-0000-0000-000000000121',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 22. Fine-Tuning LLMs
  (
    '40000000-0000-0000-0000-000000000122',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 23. AI Agents
  (
    '40000000-0000-0000-0000-000000000123',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 24. Stable Diffusion
  (
    '40000000-0000-0000-0000-000000000124',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 25. Computer Vision
  (
    '40000000-0000-0000-0000-000000000125',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 26. AI Voice
  (
    '40000000-0000-0000-0000-000000000126',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 27. TensorFlow.js
  (
    '40000000-0000-0000-0000-000000000127',  '20000000-0000-0000-0000-000000000002',
  ...
  (
    '40000000-0000-0000-0000-000000000128',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 29. Hugging Face
  (
    '40000000-0000-0000-0000-000000000129',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 33. Local AI Privacy
  (
    '40000000-0000-0000-0000-000000000133',  '20000000-0000-0000-0000-000000000002',
  ...
  -- 3. NestJS
  (
    '40000000-0000-0000-0000-000000000103',  '20000000-0000-0000-0000-000000000001',
  ...
  -- 13. Golang
  (
    '40000000-0000-0000-0000-000000000113',  '20000000-0000-0000-0000-000000000001',
  ...
  -- 14. System Design
  (
    '40000000-0000-0000-0000-000000000114',  '20000000-0000-0000-0000-000000000001',
  ...
  (
    '40000000-0000-0000-0000-000000000137',  '20000000-0000-0000-0000-000000000001',
  ...
  (
    '40000000-0000-0000-0000-000000000138',  '20000000-0000-0000-0000-000000000001',
  ...
  -- 4. React Native
  (
    '40000000-0000-0000-0000-000000000104',  '20000000-0000-0000-0000-000000000004',
  ...
  -- 15. Flutter
  (
    '40000000-0000-0000-0000-000000000115',  '20000000-0000-0000-0000-000000000004',
  ...
  -- 8. Phaser
  (
    '40000000-0000-0000-0000-000000000105',  '20000000-0000-0000-0000-000000000007',
  ...
  -- 9. React Three Fiber
  (
    '40000000-0000-0000-0000-000000000106',  '20000000-0000-0000-0000-000000000007',
  ...
  -- 30. AI for Excel
  (
    '40000000-0000-0000-0000-000000000130',  '20000000-0000-0000-0000-000000000008',
  ...
  -- 31. Viral Video AI
  (
    '40000000-0000-0000-0000-000000000131',  '20000000-0000-0000-0000-000000000009',
  ...
  -- 32. SEO Content AI
  (
    '40000000-0000-0000-0000-000000000132',  '20000000-0000-0000-0000-000000000009',
  ...
  (
    '40000000-0000-0000-0000-000000000134',  '20000000-0000-0000-0000-000000000009',
  ...
  -- 35. AI Avatars
  (
    '40000000-0000-0000-0000-000000000135',  '20000000-0000-0000-0000-000000000003',
  ...
  (
    '40000000-0000-0000-0000-000000000136',  '20000000-0000-0000-0000-000000000008',
  ...
  -- 20. Freelancing
  (
    '40000000-0000-0000-0000-000000000110',  '20000000-0000-0000-0000-000000000009',
  ...
  -- 11. Indie Hacker
  (
    '40000000-0000-0000-0000-000000000118',  '20000000-0000-0000-0000-000000000009',
  ...
  -- 16. Docker
  (
    '40000000-0000-0000-0000-000000000112',  '20000000-0000-0000-0000-000000000006',
  ...
  -- 17. SaaS Deployment
  (
    '40000000-0000-0000-0000-000000000109',  '20000000-0000-0000-0000-000000000006',
  ...
  -- 19. Git
  (
    '40000000-0000-0000-0000-000000000117',  '20000000-0000-0000-0000-000000000008',
  ...
  -- 12. Bubble.io
  (
    '40000000-0000-0000-0000-000000000119',  '20000000-0000-0000-0000-000000000010',
  ...
  -- 12B. Zapier
  (
    '40000000-0000-0000-0000-000000000120',  '20000000-0000-0000-0000-000000000010',
...
-- ============================================================================
-- 3. INSTRUCTOR-COURSE ASSIGNMENTS (Junction Table)
-- ============================================================================
INSERT INTO public.instructor_courses (instructor_profile_id, course_id, is_primary)
VALUES
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000121', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000122', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000123', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000124', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000125', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000126', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000127', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000128', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000129', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000133', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000101', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000102', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000103', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000113', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000114', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000137', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000138', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000104', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000115', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000105', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000106', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000107', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000130', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000131', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000132', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000134', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000135', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000136', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000110', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000118', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000112', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000109', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000108', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000117', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000119', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000120', TRUE),
  ('30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000139', TRUE)
ON CONFLICT DO NOTHING;

-- Apply additional data to LINE OA Course
UPDATE public.courses
SET 
  learning_outcomes = ARRAY['เข้าใจบทบาทของ LINE OA และการประยุกต์ใช้ในงานดูแลกลุ่มเป้าหมายเฉพาะ', 'สามารถสร้างบัญชีและตั้งค่าโปรไฟล์ธุรกิจ พร้อมสิทธิ์การจัดการแอดมินได้อย่างถูกต้อง', 'ออกแบบและตั้งค่า Rich Menu, ข้อความทักทายเพื่อนใหม่ และ Auto-reply เพื่อสนับสนุนการให้บริการ', 'วางแผน Content Calendar และส่งข้อความ Broadcast ได้อย่างมีประสิทธิภาพ', 'สื่อสารและแชทกับผู้รับบริการอย่างมืออาชีพโดยรักษาความลับ ข้อมูลส่วนบุคคล และยึดหลักจริยธรรม', 'สามารถออกแบบ Flow การนัดหมายเชื่อมบริการแบบ O2O และประเมินผลแคมเปญ (Analytics) ได้'],
  requirements = ARRAY['มีความรู้พื้นฐานในการใช้งานคอมพิวเตอร์และแอปพลิเคชัน LINE', 'มีบัญชี LINE ส่วนตัว และสามารถเข้าถึงเว็บไซต์ Manager (manager.line.biz) ได้'],
  target_audience = ARRAY['ทีมงานดูแลผู้ใช้สารเสพติด จังหวัดสงขลา หรือหน่วยงานที่ทำงานกับกลุ่มผู้ใช้ยา', 'เจ้าหน้าที่สาธารณสุข องค์กรพัฒนาเอกชน (NGOs) ที่ต้องการใช้ LINE OA ในการสื่อสารกับผู้รับบริการ', 'แอดมินหรือผู้ประสานงานที่ต้องการใช้ช่องทางแชทเพื่อนัดหมาย ติดตามผล และให้ข้อมูลเชิงสุขภาพแก่กลุ่มเป้าหมาย'],
  syllabus = '[{"title": "โมดูลที่ 1: รู้จัก LINE OA และบทบาทในงานของเรา"}, {"title": "โมดูลที่ 2: สร้างบัญชี LINE OA"}, {"title": "โมดูลที่ 3: ตั้งค่าบัญชีเบื้องต้น"}, {"title": "โมดูลที่ 4: ออกแบบ Rich Menu"}, {"title": "โมดูลที่ 5: ข้อความทักทายเพื่อนใหม่ (Greeting Message)"}, {"title": "โมดูลที่ 6: ข้อความตอบกลับอัตโนมัติ (Auto-reply)"}, {"title": "โมดูลที่ 7: การส่ง Broadcast"}, {"title": "โมดูลที่ 8: การสื่อสารและจัดการแชทอย่างมืออาชีพ"}, {"title": "โมดูลที่ 9: เชื่อมบริการออนไลน์สู่ออฟไลน์ (O2O)"}, {"title": "โมดูลที่ 10: วิเคราะห์และประเมินผล"}, {"title": "ภาคผนวก: ข้อควรระวังด้านความลับและจริยธรรม"}]'::jsonb,
  about_course = 'คู่มือการใช้งาน LINE Official Account ฉบับลงมือปฏิบัติ (Step-by-Step) ที่ออกแบบมาเพื่ออ้างอิงและสนับสนุนการทำงานของ "ทีมงานดูแลผู้ใช้สารเสพติด จังหวัดสงขลา" โดยเฉพาะ ผู้เรียนจะได้เรียนรู้วิธีการใช้ LINE OA เป็นเครื่องมือหลักในการให้ข้อมูล ติดตามผล นัดหมาย ส่งต่อบริการ และให้คำปรึกษาได้อย่างปลอดภัย โดยครอบคลุมตั้งแต่การสร้างบัญชี ตั้งค่าพื้นฐาน การสร้าง Rich Menu และ Auto-reply ที่เหมาะสม ตลอดจนหลักจรรยาบรรณในการแชทที่ไม่ตัดสิน (Non-judgmental) และเก็บรักษาความลับข้อมูลผู้รับบริการ เพื่อให้การดำเนินงานขององค์กรมีประสิทธิภาพสูงสุด',
  has_interactive_lab = TRUE,
  interactive_lab_slug = 'line-oa'
WHERE id = '40000000-0000-0000-0000-000000000139';
...
-- ============================================================================
-- 4. INSTRUCTOR AVAILABILITIES 
-- ============================================================================
-- Instructor 1 Availability (Every day 20:00 - 24:00)
INSERT INTO public.instructor_availabilities (id, instructor_profile_id, day_of_week, start_time, end_time, is_active)
VALUES
  ('50000000-0000-0000-0000-000000000000', '30000000-0000-0000-0000-000000000001', 0, '20:00:00', '23:59:59', TRUE),
  ('50000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 1, '20:00:00', '23:59:59', TRUE),
  ('50000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000001', 2, '20:00:00', '23:59:59', TRUE),
  ('50000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000001', 3, '20:00:00', '23:59:59', TRUE),
  ('50000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000001', 4, '20:00:00', '23:59:59', TRUE),
